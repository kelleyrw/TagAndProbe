...
datasets_el = cms.VPSet(single_el)  # electrons
...
output_label = cms.string("ss2012_ts")
...
# 	nvtx_bins = cms.vdouble(),
	...
	denominator = cms.vstring("EGammaDenBoth"),
)
...
process.tnp_make_plots = cms.VPSet(egamma_el)
